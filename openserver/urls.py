...
urlpatterns = [
    ...
    url(r'^opt$', login_required(views.openServerView.as_view()), name='opt'),
    ...
    url(r'^opensvtask/list$', (login_required(views.OpenServerTaskList.as_view())), name='openservertask_list'),
    url(r'^opensvtask/detail/(?P<pk>[\w-]+)$', login_required(views.OpenServerTaskDetail.as_view()), name='openservertask_detail'),
